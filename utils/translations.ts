...
const translations: Record<Language, Translations> = {
  en: {
    ...
    contact: "Contact",
    contactBody: "For support or questions, please open an issue on the project's GitHub page.",
    categoryNames: {
      any: "any",
      funny: "funny",
  ...
  is: {
    ...
    contactBody: "Vegna aðstoðar eða spurninga, vinsamlegast opnaðu mál á GitHub síðu verkefnisins.",
    categoryNames: {
      any: "allt",
      funny: "fyndið",
  ...
  no: {
    ...
    contact: "Kontakt",
    contactBody: "For støtte eller spørsmål, vennligst åpne en sak på prosjektets GitHub-side.",
    categoryNames: {
      any: "alle",
      funny: "morsom",
